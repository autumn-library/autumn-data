...
Завязь с таким прозвищем вправе вернуть `Неопределено` - так наблюдение выключается настройкой. Без желудей с прозвищем источники остаются без наблюдателей.
