...
Коннектор принадлежит пулу менеджера сущностей. Менеджер и хранилища выполняют алгоритм на занятом соединении: `ВыполнитьСКоннектором(Алгоритм, Контекст)` и `ВычислитьСКоннектором(Алгоритм, Контекст)`, где алгоритм - лямбда с параметром `Коннектор`.
