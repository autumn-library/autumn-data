...
Завязь с таким прозвищем вправе вернуть `Неопределено` - например, когда наблюдение выключено настройкой: такой желудь пропускается. Без желудей с прозвищем источники остаются без наблюдателей, а менеджеры создаются как раньше.
