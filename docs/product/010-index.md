...
- **Пул соединений** - соединения берутся из пула источника данных, размер пула задается в настройках источника
- **Наблюдатели источника данных** - желуди с прозвищем `НаблюдательИсточникаДанных` регистрируются на всех источниках данных
