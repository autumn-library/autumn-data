...
- **Наблюдатели источника данных** - желуди с прозвищем `НаблюдательИсточникаДанных` подставляются во все менеджеры: на этом построена интеграция с OpenTelemetry в `autumn-opentelemetry`
