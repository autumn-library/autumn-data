...
- **Наблюдатели сущностей** - желуди с прозвищем `НаблюдательСущностей` подставляются во все менеджеры: на этом построена интеграция с OpenTelemetry в `autumn-opentelemetry`
