...
Процедура КогдаЗаполненыИсточникиДанныхКакМассивНоОдинБезИмени_ТогдаБросаетсяИсключение() Экспорт
	...
	// Дано
	СоветДругогоМастера = СоветДругогоМастераСДвумяКоннекторамиИОдинБезИмениКакМассив();
...
Процедура КогдаЗапрашиваетсяХранилищеСущностейИЕстьОдинИсточникБезИмени_ТогдаОноПолучается() Экспорт
	...
	// Дано
	СоветДругогоМастера = СоветДругогоМастераСОднимКоннекторомБезИмениИсточникаКакСоответствие();
...
Функция СоветДругогоМастераСОднимКоннекторомБезИмениИсточникаКакСоответствие()
...
Функция СоветДругогоМастераСДвумяКоннекторамиИОдинБезИмениКакМассив()
...
//КогдаЗапрашиваетсяХранилищеСущностей_ТогдаОноПолучается();