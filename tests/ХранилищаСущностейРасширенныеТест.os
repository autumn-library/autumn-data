...
&Тест
&Изолированный(Совет = "() -> ГенераторДанных.СоветДругогоМастераСОднимКоннекторомБезИмениИсточникаКакСоответствие()")
Процедура КогдаХранилищеПомеченоАннотацией_ТогдаОноНаходитсяПоПрозвищуХранилищеСущностей() Экспорт

	// Дано
	РасширенноеХранилище = Поделка.НайтиЖелудь("ХранилищеФизическиеЛица");

	// Когда
	Хранилища = Поделка.НайтиЖелуди("ХранилищеСущностей");

	// Тогда: прозвище - единственный способ забрать все хранилища сразу, и расширенное
	// должно попадать в эту выдачу наравне с теми, что заготовка создает сама.
	РасширенноеНайдено = Ложь;
	Для Каждого Хранилище Из Хранилища Цикл
		Если Хранилище = РасширенноеХранилище Тогда
			РасширенноеНайдено = Истина;
		КонецЕсли;
	КонецЦикла;

	Ожидаем.Что(РасширенноеНайдено, "Расширенное хранилище ищется по прозвищу ХранилищеСущностей")
		.Равно(Истина);
