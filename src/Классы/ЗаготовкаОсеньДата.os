...
Функция ИнициализироватьИсточникиДанных()
	...
	// TODO: Если источник один и из соответствия, то имя источника можно не указывать
...
Процедура ПриИнициализацииПоделки(Поделка) Экспорт
	...
	Для Каждого ИсточникДанных Из ИсточникиДанных Цикл
		...
		Поделка.ДобавитьЗавязь(
			АннотацияВерховный + "&Завязь(Тип = ""МенеджерСущностей"", Значение = ""МенеджерСущностей" + ИсточникДанных.Имя() + """) &Прозвище(""МенеджерСущностей"") (&Пластилин(""ТипыСущностей" + ИсточникДанных.Имя() + """) ТипыСущностей) ->
		...
		// TODO: по этим типам сущностей надо еще создать список сущностей и передать его в МенеджерСущностей для инициализации.
		...
		Для Каждого ТипСущности Из ТипыСущностей Цикл
			...
			Поделка.ДобавитьЗавязь(
				"&Завязь(Тип = ""ХранилищеСущностей"", Значение = """ + ИмяХранилищаСущности + """) &Прозвище(""ХранилищеСущностей"") (&Пластилин(""" + ИмяМенеджераСущности + """) МенеджерСущности) ->
